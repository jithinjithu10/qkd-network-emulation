...
# Priority:
# 1. Use NGROK URL if provided (for IITR ↔ IITJ communication)
# 2. Fallback to localhost (for testing)

KMS_URL = os.getenv("KMS_URL", "http://localhost:8001")
...
def main():
    ...
    print(f"[INFO] Using KMS URL: {KMS_URL}")
