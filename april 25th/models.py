# models.py
# Purpose:
# Defines Key object and lifecycle for QKD KMS system.
# Handles:
# - Key states (READY, CONSUMED, EXPIRED)
# - Expiry logic
# - Fingerprint validation (for sync integrity)
#
# NOTE:
...
class Key:
    ...
    def _compute_fingerprint(self) -> str:
        """
        SHA256 fingerprint of key_value.
        Used for verifying sync consistency.
        """
    ...
    def consume(self):
        """
        Marks key as consumed (used once).
        """
    ...
    def matches(self, other_key) -> bool:
        """
        Compare two keys using fingerprint.
        """
        if not other_key:
            return False
    ...
    def to_dict(self):
        """
        Convert key object to dictionary for API responses.
        """
